...
本附录保留权威台账的完整读者投影；正文已解释影响决定的证据和限制。模式 / 发现视角：evidence-audit / {{DISCOVERY_LENS}}；Run ID：{{RUN_ID}}。父项 / 接口：{{PARENT_RUN}} / {{SELECTED_BRANCH}}。领域与尺度边界应在正文说明。

[返回论证](#main-argument)

<!-- rom-projection: claim-verdicts -->
### 逐项主张判定

| Claim | 原表述 | Evidence found | Limiting/contradicting evidence | Confidence | Active cap codes | Allowed wording | Parent impact | Decision ID |
|---|---|---|---|---|---|---|---|---|
| B-001 | TBD | E-001 | none | Insufficient | context-unverified | TBD | Revise | D-001 |

<!-- rom-projection: evidence-confidence -->
### 可信度及上限

| Claim | Directness | Full context | Method validity | Independence | Applicability | Conflict | Cap reason |
|---|---|---|---|---|---|---|---|
| B-001 | TBD | TBD | TBD | TBD | TBD | TBD | TBD |

<!-- rom-projection: gap-plan -->
### 证据缺口及停止规则

| Claim | Missing role | Cheapest next search/test | Upgrade condition | Overturn condition | Stop rule |
|---|---|---|---|---|---|
| B-001 | TBD | TBD | TBD | TBD | TBD |
...
|---|---|---|---|---|---|---|---|---|
| A-001 | B-001 | evidence | TBD | high | Revise | open | TBD | D-001 |
